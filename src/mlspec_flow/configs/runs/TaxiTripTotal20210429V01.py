...
class TaxiTripTotal20210429V01Run(Run):
    flow_dir   = "TaxiTripTotal20210429V01"
    model_name = "20210429V01"
    query      = """SELECT 
        ...
        # fields not availbale at prediction time: trip_miles, trip_end_timestamp, fare, tips, tolls, extras, payment_type
